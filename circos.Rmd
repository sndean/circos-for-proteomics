...
# Read data; calculate LFC, P

Use LIMMA to calculate log2 fold change and moderated p-values with an empirical Bayes approach according to https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4373093/
...
# Get lengths from assembly report
