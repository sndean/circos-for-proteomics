...
theme1 <- theme(panel.grid.major = element_blank(),
        ...
        axis.text.x = element_text(size = 14, color = "black", family="Arial", angle = 45, hjust = 1),
        axis.text.y = element_text(size = 14, color = "black", family="Arial"), 
        axis.title = element_text(color = "black", family="Arial"),
        strip.text.x = element_text(size = 10, color = "black", family="Arial"),
...
```{r}
read_tsv('GCF_000203855.3_ASM20385v3_feature_table.txt') %>%
...
chromosome is 3308273
plasmid	is 1917 + 2365 + 36069
...
circos.initialize(factors = ref$V1, 
                  xlim = matrix(c(rep(0, 2), ref$V2), ncol = 2))
...
circos.track(factors = circ_df$seq_type, x = circ_df$start, y = circ_df$pvalue, panel.fun = function(x, y) {
  circos.points(x, y, col = '#000000', cex = 0.1, pch = 16) # , lwd = 0.3) ### normal is 0.6? though possibly too wide
